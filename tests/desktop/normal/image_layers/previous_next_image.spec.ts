 ...
 */
test('Going next image multiple times should bring screenshot validated next available images and button/date colors should match with the matching screenshots', async ({page}, info) => {
