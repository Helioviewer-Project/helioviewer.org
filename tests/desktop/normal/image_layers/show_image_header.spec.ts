 ...
 */
test('Image headers dialog box should show layer image headers, also it should show different headers with tab controls with sorting functionality', async ({page}, info) => {
