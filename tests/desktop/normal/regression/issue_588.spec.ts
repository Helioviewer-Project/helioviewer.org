 ...
 */
test("Issue 588, special characters in event tree causing to tree to fail", async ({
  page,
  browser,
}) => {
          ...
          data: [
            {
              ...
              frm_paramset:
                "2017-09-06T12:04:00.000/nlat=192,rtop=2.5,rix=[2,37]",
              frm_specificid: "",
              ...
              hcr_checked: "false",
              hgc_bbox:
                "POLYGON((-29.343 50.801,-25.343 50.801,-25.343 54.801,-29.343 54.801,-29.343 50.801))",
              hgc_boundcc: "",
            ...
            },
            {
              ...
              hcr_checked: "true",
              hgc_bbox:
                "POLYGON((32.866 49.7656,36.866 49.7656,36.866 53.7656,32.866 53.7656,32.866 49.7656))",
              hgc_boundcc: "",
  ...
  expect(
    await eventTree.hasFRM("Topological Object", "SSW PFSS v2 + null point"),
  ).toBe(true);
  expect(
    await eventTree.frmEventCount(
      "Topological Object",
  ...
  await eventTree.toggleCheckFRM(
    "Topological Object",
    "SSW PFSS v2 + null point",
  );
  ...
  await eventTree.toggleBranchFRM(
    "Topological Object",
    "SSW PFSS v2 + null point",
  );
