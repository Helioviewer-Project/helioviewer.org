...
test('Issue 588, special characters in event tree causing to tree to fail', async ({ page, browser }) => {
                    ...
                    data: [
                        {
                            ...
                            hgc_x: -27.343,
                            hgc_y: 52.801,
                            hgs_bbox: "POLYGON((-113.207998 50.801,-109.207998 50.801,-109.207998 54.801,-113.207998 54.801,-113.207998 50.801))",
                            hgs_boundcc: "",
                            hgs_coord: "POINT(-111.207998 52.801)",
                            hgs_x: -111.207998,
                            hgs_y: 52.801,
                            hpc_bbox: "POLYGON((-552.292776 760.80618,-567.572718 756.0168,-517.700214 793.71858,-503.771232 798.08076,-552.292776 760.80618))",
                            hpc_boundcc: "",
                            ...
                            hrc_bbox: "POLYGON((0.98811 35.97706,0.993599 36.897056,0.995987 33.114262,0.99194 32.261284,0.98811 35.97706))",
                            hrc_boundcc: "",
                            ...
                            kb_archivid: "ivo://helio-informatics.org/TO_SSWPFSSv2+nullpointfinderv20180808_20180904_192913_2017-09-06T120400.000-007",
                        ...
                        },
                        {
                            ...
                            hgc_x: 34.866,
                            hgc_y: 51.7656,
                            hgs_bbox: "POLYGON((-50.998998 49.7656,-46.998998 49.7656,-46.998998 53.7656,-50.998998 53.7656,-50.998998 49.7656))",
                            hgs_boundcc: "",
                            hgs_coord: "POINT(-48.998998 51.7656)",
                            hgs_x: -48.998998,
                            hgs_y: 51.7656,
                            hpc_bbox: "POLYGON((-478.69818 673.31886,-450.560988 669.33102,-412.25664 714.59652,-438.007584 718.23894,-478.69818 673.31886))",
                            hpc_boundcc: "",
                            hpc_coord: "POINT(-445.42413 694.26804)",
                            hpc_geom: "010300000001000000050000008AABCABE2BEB7DC005C078068D0A85402D978DCEF9287CC09352D0EDA5EA8440876D8B321BC479C0481B47ACC5548640917F66101F607BC0A6ED5F59E97186408AABCABE2BEB7DC005C078068D0A8540",
                            hpc_radius: "824.870151570353869",
                            hpc_x: -445.42413,
                            hpc_y: 694.26804,
                            hrc_a: 32.6831641628919,
                            hrc_bbox: "POLYGON((0.8683 35.411045,0.848025 33.946516,0.867086 29.981003,0.884189 31.37632,0.8683 35.411045))",
                            hrc_boundcc: "",
                            ...
                            kb_archivid: "ivo://helio-informatics.org/TO_SSWPFSSv2+nullpointfinderv20180808_20180904_192913_2017-09-06T120400.000-008",
                            kb_archivist: "derosa_marc",
                            noposition: "false",
                            obs_channelid: "N/A",
                            obs_dataprepurl: "",
                        ...
                        },
                        {
                            ...
                            hgc_x: -155.146,
                            hgc_y: 40.7029,
                            hgs_bbox: "POLYGON((118.989002 38.7029,122.989002 38.7029,122.989002 42.7029,118.989002 42.7029,118.989002 38.7029))",
                            hgs_boundcc: "",
                            hgs_coord: "POINT(120.989002 40.7029)",
                            hgs_x: 120.989002,
                            hgs_y: 40.7029,
                            hpc_bbox: "POLYGON((648.59772 634.69218,621.8175 640.15128,585.63312 687.14556,610.8474 682.01364,648.59772 634.69218))",
                            hpc_boundcc: "",
                            ...
                            hrc_bbox: "POLYGON((0.953785 314.379176,0.937982 315.83233,0.948921 319.560061,0.962296 318.150698,0.953785 314.379176))",
                            hrc_boundcc: "",
                            ...
                            kb_archivid: "ivo://helio-informatics.org/TO_SSWPFSSv2+nullpointfinderv20180808_20180904_192913_2017-09-06T120400.000-005",
                            kb_archivist: "derosa_marc",
                            noposition: "false",
                            obs_channelid: "N/A",
                            obs_dataprepurl: "",
    ...
    expect(await eventTree.frmHasEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 332.66,52.80')).toBe(true);
    expect(await eventTree.frmHasEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 34.87,51.77')).toBe(true);
    expect(await eventTree.frmHasEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 204.85,40.70')).toBe(true);
    expect(await eventTree.frmHasEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object Not Exists')).toBe(false);
    ...
    await eventTree.assertEventInstanceTreeNodeVisible('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 332.66,52.80')
    ...
    await eventTree.assertEventInstanceTreeNodeNotVisible('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 332.66,52.80')
    ...
    await eventTree.toggleCheckEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 332.66,52.80');
    ...
    await eventTree.toggleCheckEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 34.87,51.77');
    // Action 11: Check event instance node "Topological Object 204.85,40.70" to show event marker attached to it
    await eventTree.toggleCheckEventInstance('Topological Object', 'SSW PFSS v2 + null point', 'Topological Object 204.85,40.70');
    ...
    await eventTree.hoverOnEventInstance('Topological Object', 'SSW PFSS v2 + null point','Topological Object 34.87,51.77');
    ...
    await eventTree.hoverOnEventInstance('Topological Object', 'SSW PFSS v2 + null point','Topological Object 204.85,40.70');
