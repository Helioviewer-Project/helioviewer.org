 ...
 */
test("Issue 647, Movie making,  'Earth Scale Indicator' is off location if the requested movie needs tobe in resolution other than 'Original' ", async ({ page, browser }, info) => {
    ...
    await expect(page.locator('.movie-player-dialog')).toHaveScreenshot('movie_player_screenshot_t.png');
