 ...
 */
test("Issue 650, Default base difference should be one hour earlier of observation date", async ({ page, browser }, info) => {
  ...
  let oneHourEarlierOfObservationDate = observationDate - (1000 * 60 * 60)
