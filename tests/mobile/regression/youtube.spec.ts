 ...
 */
test('[Mobile] "No shared movies found" should not be duplicated', async ({
  page,
}) => {
 ...
 */
test("[Mobile] Youtube videos should be rendered correctly", async ({
  page,
}) => {
  // 0. Mock API requests
...
const OBSERVATION_DATE_VIDEOS_JSON = [
  {
    ...
    imageScale: 15.5199,
    dataSourceString:
      "[SOHO,LASCO,C3,white-light,3,100,0,60,0,2024-06-05T04:03:50.000Z]",
    eventSourceString: "",
    movieLength: "14.2857",
    width: 1582,
    height: 732,
...
const YOUTUBE_VIDEO_JSON = [
  {
    ...
    thumbnails: {
      ...
      small:
        "https://api.helioviewer.org/cache/movies/2024/08/19/TvlW5/preview-small.png",
      medium:
        "https://api.helioviewer.org/cache/movies/2024/08/19/TvlW5/preview-medium.png",
      large:
        "https://api.helioviewer.org/cache/movies/2024/08/19/TvlW5/preview-large.png",
  ...
  },
  {
    ...
    thumbnails: {
      ...
      small:
        "https://api.helioviewer.org/cache/movies/2024/08/19/qvlW5/preview-small.png",
      medium:
        "https://api.helioviewer.org/cache/movies/2024/08/19/qvlW5/preview-medium.png",
      large:
        "https://api.helioviewer.org/cache/movies/2024/08/19/qvlW5/preview-large.png",
  ...
  },
  {
    ...
    thumbnails: {
      ...
      small:
        "https://api.helioviewer.org/cache/movies/2024/08/19/FvlW5/preview-small.png",
      medium:
        "https://api.helioviewer.org/cache/movies/2024/08/19/FvlW5/preview-medium.png",
      large:
        "https://api.helioviewer.org/cache/movies/2024/08/19/FvlW5/preview-large.png",
