...
const OBSERVATION_DATE_VIDEOS_JSON = [
	{
		...
		"description": "This movie was produced by Helioviewer.org. See the original at https://api.helioviewer.org/?action=playMovie&id=KflW5&format=mp4&hq=true or download a high-quality version from https://api.helioviewer.org/?action=downloadMovie&id=KflW5&format=mp4&hq=true",
...
const YOUTUBE_VIDEO_JSON = [
	{
		...
		"description": "This movie was produced by Helioviewer.org. See the original at https://api.helioviewer.org/?action=playMovie&id=TvlW5&format=mp4&hq=true or download a high-quality version from https://api.helioviewer.org/?action=downloadMovie&id=TvlW5&format=mp4&hq=true",
		"keywords": "SOHO,LASCO,C2,white-light,C3",
		"imageScale": "77.4541",
		"dataSourceString": "[SOHO,LASCO,C2,white-light,2,100,0,60,1,2024-08-18T09:54:09.000Z],[SOHO,LASCO,C3,white-light,3,100,0,60,1,2024-08-19T13:06:09.000Z]",
		"eventSourceString": "",
		"movieLength": "10",
		"width": "1920",
		"height": "1080",
	...
	},
	{
		...
		"description": "This movie was produced by Helioviewer.org. See the original at https://api.helioviewer.org/?action=playMovie&id=qvlW5&format=mp4&hq=true or download a high-quality version from https://api.helioviewer.org/?action=downloadMovie&id=qvlW5&format=mp4&hq=true",
	...
	},
	{
		...
		"description": "This movie was produced by Helioviewer.org. See the original at https://api.helioviewer.org/?action=playMovie&id=FvlW5&format=mp4&hq=true or download a high-quality version from https://api.helioviewer.org/?action=downloadMovie&id=FvlW5&format=mp4&hq=true",
		"keywords": "SDO,AIA,304,1",
		"imageScale": "0.60511",
		"dataSourceString": "[SDO,AIA,304,1,100,0,60,1,2024-08-08T12:46:22.000Z]",
		"eventSourceString": "",
