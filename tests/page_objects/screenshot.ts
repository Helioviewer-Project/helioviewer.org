...
class Screenshot {
   ...
   * @return void
   */
  async viewScreenshotFromScreenshotHistory(
    index: number,
    wait: boolean = false,
  ) {
    if (wait) {
    ...
    await this.page
      .locator(
        `#screenshot-history .history-entry:nth-child(${index}) a.text-btn`,
      )
      .click();
    await this.page.mouse.move(200, 200);
    await this.page.mouse.up();
  ...
  async closeScreenshotView() {
    await this.page
      .locator(".__react_modal_image__icon_menu > a:nth-of-type(2)")
      .click();
    await this.page.mouse.move(200, 200);
    await this.page.mouse.up();
  }
  ...
  async fetchScreenshotFromViewScreenshotFeature() {
    ...
    await this.page
      .locator(".__react_modal_image__icon_menu > a:nth-of-type(1)")
      .click();
  ...
  async waitForScreenshotCompleteNotifitication() {
    await expect(
      this.page.getByText(
        "Your AIA 304 screenshot is ready! Click here to download.",
      ),
