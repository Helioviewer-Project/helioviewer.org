...
class HvMobile {
  ...
  constructor(page: Page, info: TestInfo | null = null) {
    ...
    this._image_drawer_btn = this.page.locator(
      '[drawersec="accordion-images"]',
    );
  ...
  async OpenImageLayerDrawer() {
    ...
    if (
      (await this._IsDrawerClosed()) ||
      (await this._image_drawer.isHidden())
    ) {
  ...
  async IsSidebarOpen(): Promise<boolean> {
    ...
    return await this.page.evaluate(
      () => document.querySelector(".zeynep.opened") != null,
    );
  }
  ...
  async OpenAnnouncements() {
    ...
    await this.TapIfVisible(
      this.page.getByText("Helioviewer Project Announcements."),
    );
  }
  ...
  async CloseAnnouncements() {
    await this.TapIfVisible(
      this.page.locator("#hv-drawer-news .hvmobmenuclose"),
    );
  }
  ...
  async OpenYoutubeVideosDialog() {
    await this.OpenSidebar();
    await this.TapIfVisible(
      this.page.getByText("View Helioviewer MoviesShared"),
    );
  }

  async CloseYoutubeVideosDialog() {
    await this.TapIfVisible(
      this.page.locator("#hv-drawer-youtube .hvmobmenuclose"),
    );
  }
  ...
  async CloseMovieDialog() {
    await this.TapIfVisible(
      this.page.locator("#hv-drawer-movies .hvmobmenuclose"),
    );
  }
  ...
  async CloseScreenshotsDialog() {
    await this.TapIfVisible(
      this.page.locator("#hv-drawer-screenshots .hvmobmenuclose"),
    );
  }
  ...
  async OpenShareViewportDialog() {
    await this.OpenSidebar();
    await this.TapIfVisible(
      this.page.getByText("Share the current viewport on social media."),
    );
  }

  async CloseShareViewportDialog() {
    await this.TapIfVisible(
      this.page.locator("#hv-drawer-share .hvmobmenuclose"),
    );
  }
