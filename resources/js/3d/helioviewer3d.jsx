...
function Hv3D({coordinator, layers, date, setCameraPosition, onFail, onLoadStart, onLoadFinish }) {
  ...
  return <Layers onLoadStart={onLoadStart} onLoadFinish={onLoadFinish} date={date} layers={layers} coordinator={coordinator} setCameraPosition={setCameraPosition} onFail={onFail} />;
}
