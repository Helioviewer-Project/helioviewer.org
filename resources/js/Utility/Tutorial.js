	...
	boneVojage([
        {
			...
			selector: '#menus',
			text: '<b>Navigation Menu</b><br><br><p style="text-align:left"><img src="https://beta.helioviewer.org/resources/images/projectanounce_icon_white.png"> : Helioviewer Project Announcements.<BR>\
<img src="https://beta.helioviewer.org/resources/images/viewyoutube_icon_white.png"> : View Helioviewer Movies Shared to YouTube.<BR>\
<img src="https://beta.helioviewer.org/resources/images/createmovie_icontest.png"> : Create a movie.<BR>\
<img src="https://beta.helioviewer.org/resources/images/screenshot_icon_white.png"> : Create a screenshot.<BR>\
<img src="https://beta.helioviewer.org/resources/images/datadownload_icon_white.png"> : Request Science Data Download from External Partners.<BR>\
<img src="https://beta.helioviewer.org/resources/images/shareviewport_icon_white.png"> : Share the current viewport on social media.<BR>\
<img src="https://beta.helioviewer.org/resources/images/help_icon_white.png"> : Get Help with Helioviewer.<BR>\
<img src="https://beta.helioviewer.org/resources/images/setting_icon_white.png"> : Edit Settings &amp; Defaults.</p><br></br> <a href="http://wiki.helioviewer.org/wiki/Helioviewer.org_User_Guide_3.1.0#Sidebar_Panels" target="_blank">Click here <span class="fa fa-external-link fa-fw"></span></a> to read about each menu item and functionality.',
			position: 'bottom'
		},{
