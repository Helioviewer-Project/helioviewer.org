...
class MinimalEventLoader extends EventLoader {
    ...
    draw() {
        ...
        const eventContainer = $('<div id="minimal-event-container" class="event-container"></div>').appendTo("#moving-container");
    ...
    parseEvents(eventData) {
        ...
        for (const et of eventData) {
            ...
            for (const frmNode of et['groups']) {
                ...
                let eventsKey = EventLoader.eventLabelsMap[eventPin].source + ">>" + EventLoader.eventLabelsMap[eventPin].name + ">>" + frmNodePin
