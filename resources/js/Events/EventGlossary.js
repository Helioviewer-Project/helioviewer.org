const eventGlossary = {
    ...
    "event_coordsys": {
        ...
        "hv_type": null,
        "hek_type": "string",
        "hek_desc": "Coordinate system type (Choose between UTC-HGS-TOPO [Heliographics Stonyhurst]; UTC-HPR-TOPO [Helioprojective]; UTC-HGC-TOPO[Heliographic Carrington]; UTC-HCR-TOPO[Helio-centric radial])"
    },
    "event_coordunit": {
        "hv_label": null,
        "hv_desc": null,
    ...
    "frm_versionnumber": {
        ...
        "hv_type": null,
        "hek_type": "float",
        "hek_desc": "Version number of automated Feature Recognition Method (Put age if Human. Just kidding. In this case put 1.0)"
    },
    "frm_url": {
        "hv_label": null,
        "hv_desc": null,
    ...
    "rasterscantype": {
        ...
        "hv_type": null,
        "hek_type": "string",
        "hek_desc": "Type of raster scan (E.g. 'EGSO_SFC' if you are using the EGSO Solar Feature Catalogue convection for the raster scan)"
    },
    "skel_chaincode": {
        "hv_label": null,
        "hv_desc": null,
        "hv_type": null,
        "hek_type": "string",
        "hek_desc": "Skeleton code. A skeleton code is like a chain code except it isn't closed. (ordered list delimited by commas. e.g. 'x1, y1, x2, y2, x3, y3')"
    },
    "skel_curvature": {
        "hv_label": null,
        "hv_desc": null,
    ...
    "fi_barbsstartc1": {
        ...
        "hv_type": null,
        "hek_type": "string",
        "hek_desc": "List of Coord 1 of beginnings (closest to spine) of barbs (list delimited by commas for each numbered barb. e.g. 'x1, x2, x3')"
    },
    "fi_barbsstartc2": {
        "hv_label": null,
        "hv_desc": null,
        "hv_type": null,
        "hek_type": "string",
        "hek_desc": "List of Coord 2 of beginnings (closest to spine) of barbs (list delimited by commas for each numbered barb. e.g. 'y1, y2, y3')"
    },
    "fi_barbsendc1": {
        "hv_label": null,
        "hv_desc": null,
