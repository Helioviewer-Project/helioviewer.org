...
class WebClient implements Module
{
    ...
    {
        include_once 'lib/HelioviewerTile.php';
        $tile = new HelioviewerTile(
    ...
    {
        include_once 'lib/JHV.php';
        if ((isset($this->_params['files'])) && ($this->_params['files'] != "")) {
            $jhv = new JHV($this->_params['files']);
        } else {
            $jhv = new JHV();
        }
        $jhv->launch();
    ...
    {
        include_once 'lib/Screenshot.php';
    ...
    {
        include_once 'lib/CompositeImage.php';
