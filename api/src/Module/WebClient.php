...
?>
                ...
                <table class="param-list" cellspacing="10">
                    <tbody valign="top">
                        ...
                        <tr>
                            <td><b>centerX</b></td>
                            <td><i>Float</i></td>
                            <td>Horizontal offset from the center of the Sun
                            in arc-seconds.</td>
                        </tr>
                        <tr>
                            <td><b>centerY</b></td>
                            <td><i>Float</i></td>
                            <td>Vertical offset from the center of the Sun in
                            arc-seconds.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><i>2d List</i></td>
                            <td>A comma-separated list of the image layers to
                            be displayed. Each image layer should be of the
                            form: [OBSERVATORY, INSTRUMENT, DETECTOR,
                            MEASUREMENT, VISIBLE, OPACITY].</td>
                        </tr>
                        <tr>
                            <td><b>movieId</b></td>
                            <td><i>String</i></td>
                            <td>Identifier of Helioviewer.org movie to display
                            when page is loaded.</td>
                        </tr>
                        <tr>
                            <td><b>output</b></td>
                            <td><i>String</i></td>
                            <td>Output format to use when displaying the page.
                            Currently there are two accepted output formats:
                            "web" and "embed". If no output method is
                            specified the output will default to the standard
                            web display.</td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div id="ScreenshotAPI">
            ...
            <h1>Screenshots</h1>
            <p></p>
                The Screenshot API provides a way for users to create custom
                single-layer and composite images using Helioviewer.org.
                Depending on how you plan to use the screenshot, the process
                can be handled in either one or two steps. In the simplest
                case, <a href='#takeScreenshot'>takeScreenshot</a> is called
                with "display=true" and an image is returned directly.
                Alternatively, when the display parameter is not set to true
                in the request an identifier is returned which can then be
                used by the
                <a href='#downloadScreenshot'>downloadScreenshot</a> method to
                display the image. This is useful when you want to provide a
                reusable link to the image you create.
            <br />
            ...
            <div id="takeScreenshot">
                ...
                <p>Returns a single image containing all layers/image types
                requested. If an image is not available for the date requested
                the closest available image is returned. The region to be
                included in the screenshot may be specified using either the
                top-left and bottom-right coordinates in arc-seconds, or a
                center point in arc-seconds and a width and height in pixels.
                See the <a style="color:#3366FF" href="#Coordinates">
                Coordinates Appendix</a> for more infomration about working
                with coordinates in Helioviewer.org.</p>
                <br />
                ...
                <table class="param-list" cellspacing="10">
                    <tbody valign="top">
                        <tr>
                            ...
                            <td>Timestamp of the output image. The closest
                            timestamp for each layer will be found if an exact
                            match is not found.</td>
                        </tr>
                        <tr>
                            <td><b>imageScale</b></td>
                            <td><i>Float</i></td>
                            <td>The zoom scale of the image. Default scales
                        ...
                        <tr>
                            ...
                            format:<br />
                            Each layer is comma-separated with these values:
                            [<i>sourceId,visible,opacity</i>]. <br />
                        ...
                        <tr>
                            <td><b>width</b></td>
                            <td><i>Integer</i></td>
                            <td><i>[Optional]</i> Width of the screenshot in
                            pixels (Maximum: 1920).</td>
                        </tr>
                        <tr>
                            <td><b>height</b></td>
                            <td><i>Integer</i></td>
                            <td><i>[Optional]</i> Height of the screenshot in
                        ...
                        <tr>
                            ...
                            screenshot will display on the page when it is
                            ready. If display is false, the filepath to the
                            screenshot will be returned. If display is not
                            specified, it will default to true (Default=false).
                            </td>
                        </tr>
                        <tr>
                            <td><b>watermark</b></td>
                            <td><i>Boolean</i></td>
                            <td><i>[Optional]</i> Whether or not the include
                            the timestamps and the Helioviewer.org logo in the
                            screenshot (Default=true).</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div id="downloadScreenshot">
                ...
                <p>Displays the screenshot associated with the specified id.
                </p>
                ...
                <table class="param-list" cellspacing="10">
                    <tbody valign="top">
                        <tr>
                            ...
                            <td><i>Integer</i></td>
                            <td>The screenshot id as returned from
                            <a href='#takeScreenshot'>takeScreenshot</a>.</td>
                        </tr>
                    </tbody>
                </table>
