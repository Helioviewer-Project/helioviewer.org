 ...
 * @see   LayerManagerUI
 */
/*global Class, document, $, $A, Debug, TileLayerProvider, numberOfTileLayers, numberOfMarkerLayers */
...
LayerManager.prototype = {
    ...
    initialize: function (tileContainer, zoomLevel) {
        ...
        document.opacityChange.subscribe(this.onOpacityChange, this, true);
        ...
        document.zoomLevelChange.subscribe(function (type, args) {
    ...
    addLayer: function (layerProvider) {
        ...
        //Debug.output("Added new layer. layers.length: " + this.layers.length + ", layerProvider.id: " + layerProvider.id);
    },
    ...
    removeLayer: function (id) {
        ...
        this.layers[id] = null;
        this.layers = this.layers.compact();
    },
    /**
     * @method onAddLayer
     */
     ...
     * @param {Int} opacity
     */
    onOpacityChange: function (type, args) {
    	var id = args[0];
    	var opacity = args[1];
