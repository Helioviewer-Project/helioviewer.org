...
var MovieBuilder = Class.create(UIElement, {
	...
	buildMovie: function (self, visibleCoords) {
		var helioviewer = self.controller, zoomLevel, startTime, timeStep, hqformat, timeout, layers = $A(), layerNames = $A(), imgHeight, imgWidth, vpWidth, vpHeight, sbWidth, sbHeight, maxImgSize, hcOffset, url, xhr, dateString, showImgIfGap, emailUser, emailAddress;
