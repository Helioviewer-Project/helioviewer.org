 ...
 * Syntax: jQuery (x)
 */
/*global Class, jQuery, $, Shadowbox, setTimeout, window */
var MovieBuilder = Class.create(
	...
	buildMovie: function (layers) {
		var mediaSettings, timeout, imgHeight, imgWidth, options, params, callback, self = this;
...
//		self.updateProgress(timeout);	
		...
		jQuery.post(this.url, params, callback, "json");
    },
