...
var MovieBuilder = Class.create(UIElement, {
	...
	initialize: function (controller) {
		...
		this.button.click(function () {			
			...
			// buildMovie is sent "null" for visibleCoords because visibleCoords = viewport coordinates and is calculated in another function.
		...
		/*		Shadowbox.open({
					...
					width: 	500,
					height: 160,
					title:	'Helioviewer Movie Options',
					content:	'<div id="shadowbox-form" class="ui-widget-content ui-corner-all" style="margin: 10px; padding: 20px; height: 100px; font-size: 12pt;">' +
									...
									'<input id="select-option" type=radio value="Default">Default</input>' +
									'<input id="select-option" type=radio value="Advanced">Advanced</input>' + 
