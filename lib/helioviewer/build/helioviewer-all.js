...
var Helioviewer = Class.create(
	...
	initialize: function (options) {
		...
		// Starting date
		this.date = new Date(parseInt(this.userSettings.get('obs-date'), 10));
...
var TileLayer = Class.create(Layer, 
	...
	reset: function (visible) {
		var i, j, zoomOffset, old, numTiles, numTilesLoaded, indices, tile, onLoadComplete, self = this;
...
var Viewport = Class.create(UIElement, 
	...
	updateSandbox: function () {
		var maxDimensions, old, center, newSize, change, movingContainerOldPos, newHCLeft, newHCTop;
