    ...
    doubleClick: function (e) {
        ...
        if ((e.shiftKey || (viewport.zoomLevel > viewport.controller.minZoomLevel)) && (viewport.zoomLevel < viewport.controller.maxZoomLevel)) {
            if (e.isLeftClick()) {
				...
				// TEST                
				//var marker = new Element('div', {style: 'position: absolute; border: 3px solid blue; left:' + mouseCoords.x + 'px; top: ' + mouseCoords.y + 'px;'})
                //$('helioviewer-viewport').insert(marker);

                // Determine location of click relative to the Heliocentric origin
