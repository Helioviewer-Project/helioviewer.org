...
var EventLayerAccordion = Class.create(Layer, {
	...
	getEventCatalogs: function () {
		...
		var processResponse =function(transport) {
			...
			lm.addLayer(new EventLayer(this.viewport, {catalog: "VSOService::cmelist", eventAccordion: this}));
			lm.addLayer(new EventLayer(this.viewport, {catalog: "GOESXRayService::GOESXRay",  eventAccordion: this}));
			lm.addLayer(new EventLayer(this.viewport, {catalog: "VSOService::noaa",  eventAccordion: this, windowSize: 86400}));
		};
