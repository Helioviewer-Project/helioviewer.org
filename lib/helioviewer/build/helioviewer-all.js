	...
	getEventCatalogs: function () {
		...
		var processResponse = function (transport) {
			...
			if (typeof(catalogs) !== "undefined") {
				...
				lm.addLayer(new EventLayer(this.controller.viewport, {
		...
		xhr = new Ajax.Request(this.controller.api, {
			method: "POST",
...
var EventMarker = Class.create(
	...
	createLabel: function () {
		var display = this.eventLayer.viewport.controller.eventLayers.getLabelVisibility(),
...
var Helioviewer = Class.create(
	...
	setDate: function (date) {
        ...
        this.tileLayers.reloadLayers();
        this.eventLayers.reloadLayers();
	},
...
var TileLayerAccordion = Class.create(Layer,
    ...
    updateTimeStamp: function (layer) {
        ...
        //var ts = this.controller.timeStepSlider.timestep.numSecs;
...
var TileLayerManager = Class.create(LayerManager,
   ...
   initialize: function($super, controller) {
	...
	addNewLayer: function () {
		var currentLayers, next, layerSettings, defaultLayer = "SOH_EIT_EIT_171";
		...
		currentLayers.each(function(id) {
			this._queue = this._queue.without(id);
		});
		
        // Pull off the next layer on the queue
		next = this._queue.first() || defaultLayer;
