	...
	addLayer: function (layer) {
		...
		// Callback
		 callback = function (data) {
			...
			var visibilityBtn, removeBtn, hidden, head, body, slider;
			...
			body = self._buildEntryBody(layer);
			...
			self.layerSettings.set(layer.id, {
				header: head,
				body: body,
			...
			// Event-handlers
			self._setupEventHandlers(layer);
			
			// Update timestamp
			self.updateTimeStamp(layer);
