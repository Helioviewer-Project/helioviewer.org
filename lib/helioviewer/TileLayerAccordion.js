	...
	_showFITS: function (event, layer) {
		...
		if (jQuery("#" + dialogId).length === 0) {
			...
			processResponse = function (transport) {
                ...
                formatted += "<div class='fits-regular' style='padding:1.5em 1.7em; font-size: 14px;'>";
                ...
                formatted += "<div class='fits-sorted' style='padding:1.5em 1.7em; font-size: 14px; display: none;'>";
                ...
                sortBtn = "<span style='right:2px; font-weight: bold; font-size: 10px; position: absolute; top:2px; cursor: pointer;'>Abc</span>";
