...
//		var self = this,
        var trash = new Effect.Appear(this.console);
    },

	clear: function () {
		var trash = new Effect.Fade(this.console);
	},
...
//		var self = this,
	 ...
	 */
    warn: function (msg) {
        this.console.update(new Element('p', {style: 'color: orange; font-weight: bolder;'}).insert(msg));
		var self = this,
        	trash = new Effect.Appear(this.console, { duration: 3.0 });
