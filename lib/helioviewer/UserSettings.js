...
var UserSettings = Class.extend(
    ...
    /**
     * @description Breaks up a given layer identifier (e.g. SOHO,LASCO,C2,WL) into
	 ...
	 */
	_exists: function () {
        //return ($.support.localStorage ? (localStorage.getItem("settings") !== null) : (this.cookies.getKeys().length > 0));
        return ($.support.localStorage ? (localStorage.getItem("settings") !== null) : (this.cookies.toString().length > 2));
	},
