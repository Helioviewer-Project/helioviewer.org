...
/*			onSelectChange:	function (img, selection) {
	...
	takeScreenshot: function (helioviewer, visibleCoords) {
		var zoomLevel, obsDate, layerNames = $A(), xhr, hcOffset, imgWidth, imgHeight, vpDimensions, vpWidth, vpHeight, sbWidth, sbHeight, url, mediaSettings;
		mediaSettings 	= this.mediaSettings;
		mediaSettings.getDefaultInformation(this.mediaSettings, visibleCoords);
