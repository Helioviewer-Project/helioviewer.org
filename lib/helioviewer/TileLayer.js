...
var TileLayer = Layer.extend( 
	...
	getTileURL: function (server, x, y) {
		var uri, zoom, format, src;
		
		uri    = this.filepath + "/" + this.filename;
		zoom   = this.viewport.zoomLevel;
		format = (this.layeringOrder === 1 ? "jpg" : "png");
		
		src  = server + '?action=getTile&uri=' + uri + '&x=' + x + '&y=' + y + '&zoom=' + zoom + '&ts=' + this.tileSize;
		src += '&jp2Width=' + this.width + '&jp2Height=' + this.height + '&jp2Scale=' + this.scale + '&format=' + format;
		src += '&obs=' + this.observatory + '&inst=' + this.instrument + '&det=' + this.detector + '&meas=' + this.measurement + '&date=' + this.date;
