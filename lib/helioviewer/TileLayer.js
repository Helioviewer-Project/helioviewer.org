...
var TileLayer = Layer.extend( 
    ...
    reset: function (zoomLevelChanged) {
        ...
        // Offset image
        offsetX = ((this.width  / 2) - this.x) * this.scaleFactor;
        offsetY = ((this.height / 2) - this.y) * this.scaleFactor;
        ...
        this.dimensions = {
            "left"   : (this.relWidth  / 2) + offsetX,
            "top"    : (this.relHeight / 2) + offsetY,
            "bottom" : (this.relHeight / 2) - offsetY,
            "right"  : (this.relWidth  / 2) - offsetX,
        };
