...
var TileLayer = Layer.extend( 
    ...
    getTileURL: function (server, x, y) {
        var uri, zoomLevel, format, src, offsetX, offsetY;
        ...
        src += '&jp2Width=' + this.width + '&jp2Height=' + this.height + '&jp2Scale=' + this.scale + '&offsetX=' + this.offsetX + '&offsetY=' + this.offsetY;
        src +=  '&format=' + format + '&obs=' + this.observatory + '&inst=' + this.instrument + '&det=' + this.detector + '&meas=' + this.measurement;
