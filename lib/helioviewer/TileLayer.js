...
var TileLayer = Layer.extend( 
	 ...
	 * </div>
	 */
	init: function (viewport, options) {
        ...
        this.domNode = $('<div class="tile-layer-container" style="position: absolute;"></div>').appendTo(viewport.movingContainer);
	...
	loadClosestImage: function () {
        ...
        // 2009/09/10: Adding name from datasource tree (TODO: Cleanup, "opacityGrp" -> "layeringOrder")
        datasource = this.viewport.controller.dataSources[this.observatory][this.instrument][this.detector][this.measurement];
        this.name = datasource.name;
        this.opacityGroupId = datasource.layeringOrder;
	...
	getTile: function (x, y) {
        ...
        img.error(function (e) {
            ...
            if (self.viewport.controller.backupEnabled) {
                ...
                $(this).attr("src", self.viewport.controller.backupServer + '?action=getTile&x=' + x + '&y=' + y + '&zoom=' + zoom + '&uri=' + self.uri + '&ts=' + ts);
