...
/*global Class, Calendar, EventLayerAccordion, EventLayerManager, EventTimeline, LayerManager, ImageSelectTool, MediaSettings, MovieBuilder, TileLayerManager, MessageConsole, Shadowbox, TileLayer, TileLayerAccordion, TimeControls, UserSettings, ZoomControls, Viewport, document, console, window, Time */
var Helioviewer = Class.extend(
	...
	_initUI: function () {
        ...
        mouseCoords = $('<div id="mouse-coords" style="display: none;"></div>');
		...
		var ids = "#zoomControlZoomOut, #zoomControlZoomIn, #zoomControlHandle, #fullscreen-btn, #timeBackBtn, #timeForwardBtn, #center-button";
        $(ids).qtip({
			style: {
				name: 'helioviewer'
			}
    ...
    _checkBrowser: function () {
        ...
        // Web storage (local)
        $.support.localStorage = ((typeof(localStorage) !== "undefined") && (localStorage !== null)) ? true: false;
