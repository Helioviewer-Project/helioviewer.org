...
var Helioviewer = Class.create(
    ...
    _createFullscreenBtn: function () {
        var btn, footer, vp, sb, speed, marginSize, offsetWidth, origOutsideMarginLeft, 
            origOutsideMarginRight, origHeaderHeight, origViewportHeight, origSandBoxLeft, origSandBoxTop, self;
        ...
        btn.click(function() {
            ...
            if (outsideBox.hasClass('fullscreen-mode')) {
                ...
                origSandBoxLeft        = parseInt(jQuery(".sandbox").css("left"));
                origSandBoxTop         = parseInt(jQuery(".sandbox").css("top"));
                
                // Difference
                offsetWidth = parseInt(origOutsideMarginLeft) - (2 * marginSize) - 24;
                ...
                sb.animate({
                    left: origSandBoxLeft + offsetWidth,
                    top : origSandBoxTop  + parseInt(origHeaderHeight) + 12
                }, speed,
                function () {
	...
	_initEvents: function () {
        ...
        jQuery('#center-button').click(
            this.viewport.center.call(this.viewport)
        );
	},
