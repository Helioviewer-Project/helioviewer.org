...
var Helioviewer = Class.create({
	...
	initialize: function (options) {
		...
		this.initViewports();
		this.layerManager = new LayerManager(this.viewports[0]);
		this.initUI();
		this.initEvents();
		this.initKeyBoardListeners();
		
		//Add initial layers
		this.viewports[0].addLayer(new TileLayer(this.viewports[0], { tileUrlPrefix: this.tileUrlPrefix, observatory: 'soho', instrument: 'EIT', detector: 'EIT', measurement: '304' }));
	...
	initUI: function () {
		...
		this.tileLayerAccordion = new TileLayerAccordion(this.viewports[0], 'layerManager');
