...
//		Shadowbox.init({skipSetup: true});
	...
	/**
	 * Button allows the user to select a subregion of the image by clicking and dragging across the screen.
	 */	
	_createSelectRegionButton: function() {
		...
		button.click(function() {
			...
			dialog = self.viewport.domNode.appendChild(Builder.node('div', {
	...
	cancelDialog: function() {
		jQuery("#select-image-dialog").dialog("close"); 
		jQuery('#transparent-image').imgAreaSelect({ disable: true, hide: true});		
	},
