	...
	loadUserSettings: function () {
		...
		if (this.load.layers) {
			...
			$A(this.load.layers).each(function (layer) {
				...
				layers.push({ tileAPI: "api/index.php", server: tilingServer, observatory: layer.substr(0, 3), instrument: layer.substr(3, 3), detector: layer.substr(6, 3), measurement: layer.substr(9, 3) });
			});
