...
var Helioviewer = Class.create(
	 ...
	 */
	initUI: function () {
		var centerBtn, fsBtn, mouseCoords, outsideBox, h, footer, vp, self = this;
        ...
        // Fullscreen button
        fsBtn =  Builder.node('div', {id: 'full-screen-btn'}, Builder.node('div', {className: 'ui-icon ui-icon-arrow-4-diag'}));
		this.viewports[0].innerNode.insert(fsBtn);
        jQuery('#full-screen-btn').click(function() {
            outsideBox = jQuery('#outsideBox').toggleClass('fullscreen-mode');
            ...
            if (outsideBox.hasClass('fullscreen-mode')) {
                outsideBox.animate({ 
                    ...
                    function () {
                        jQuery("#left-col, #right-col, #footer-links-container-outer").hide();
                ...
                jQuery("#left-col, #right-col, #footer-links-container-outer").show();
           		h = Math.max(self.viewports[0].minHeight, jQuery(window).height() - self.viewports[0].headerAndFooterHeight);
                outsideBox.animate({ 
                    marginLeft: "280px",
                    marginRight: "250px"
                }, 500 );
