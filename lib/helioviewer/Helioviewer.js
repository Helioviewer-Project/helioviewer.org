...
var Helioviewer = Class.create({
    ...
    initEvents: function () {
	    ...
	    this.observe(this.calendar.timeField.value, 'change', this.handlers.observationTimeChange);
    },
    ...
    handlers: {
	    ...
	    observationTimeChange: function (date) {
	        //TODO: NEED TO FIRST UPDATE this.date TO REFLECT CHANGES!
	        Debug.output("time changed!");
            this.setDate(date);
        },
