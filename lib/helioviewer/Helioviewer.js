 ...
 *     EventLayer, EventLayerAccordion, EventLayerManager, EventTimline, Helioviewer,
 *     ImageSelectTool, Layer, LayerManager, LoadingIndicator, MediaSettings, MovieBuilder, TileLayer,
 *     TileLayerAccordion, TileLayerManager, UserSettings, Viewport, ViewportHandlers
 * 
...
var Helioviewer = Class.create(
    ...
    _checkBrowser: function () {
        ...
        // Web storage (local)
        this.support.localStorage = ((typeof(localStorage) !== "undefined") && (localStorage !== null)) ? true: false;
		...
		Event.observe(document, 'keypress', function (e) {
			...
			if (e.target.tagName !== "INPUT") {
				...
				if (character === "-" || character === "_") {
					self.zoomControls.zoomButtonClicked(+1);
				}
