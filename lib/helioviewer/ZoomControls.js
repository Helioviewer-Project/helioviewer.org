...
var ZoomControls = Class.extend(
    ...
    _setupTooltips: function () {
        $("#zoomControlSlider > .ui-slider-handle").attr("title", "Drag this handle up and down to zoom in and out of the displayed image.")
        this.controller.tooltips.createTooltip($("#zoomControlZoomOut, #zoomControlZoomIn, #zoomControlHandle, #zoomControlSlider > .ui-slider-handle"));
    },
