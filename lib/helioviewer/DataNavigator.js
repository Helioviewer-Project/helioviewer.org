 ...
 * @see Filter
 */
 /*global document, window, Event, UIElement, Class, Hash, $, $A, Effect, Filter, DATE_END_EIT, DATE_START_EIT */
...
*/        
    ...
    addFilter: function (instrument, wavelength) {
        ...
        newLayer.clear();
        newLayer.retreive(null, null, null, this.controller.date, "forward");
    ...
    onInstrumentChange: function (type, args) {
        ...
        this.filters[id].retreive(null, null, null, this.controller.date, "forward"); //Filters could also keep track of time and call this within SetInstrument()...
    ...
    onWavelengthChange: function (type, args) {
        ...
        this.filters[id].retreive(null, null, null, this.controller.date, "forward");
        document.sunImageChange.fire(this.filters[id].currentSunImage(), id);
    },
    ...
    setTime: function (year, month, day, hour, minute, second) {
        ...
        if ((year !== null) && (month !== null) && (day !== null)) {
            this.controller.date.setFullYear(year, month - 1, day);
        }
        
        // Set new time (Add validation check (ideally before this function)! can use date.js validation...)
        if ((hour !== null) && (minute !== null) && (second !== null)) {
            this.controller.date.setHours(hour);
            this.controller.date.setMinutes(minute);
            this.controller.date.setSeconds(second);            
        }
        ...
        document.timeChange.fire(this.controller.date);       
    },
