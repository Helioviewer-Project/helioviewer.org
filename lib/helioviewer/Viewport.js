...
/*global Class, $, ViewportHandlers, document */
"use strict";
var Viewport = Class.extend(
    ...
    init: function (controller, options) {
        ...
        this.sandbox = $('<div id="sandbox" style="position: absolute; width: 0; height: 0; left: ' + center.x + 'px; top: ' + center.y + 'px;"></div>');
     ...
     */
    getRSun: function () {
        return (this.rsun0 / Math.pow(2, this.zoomLevel)); //this.sunRadius0 >> this.viewport.zoomLevel;
    },
