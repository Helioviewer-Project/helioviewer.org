 ...
 */
/*global Class, UIElement, $, Builder, Element, jQuery, ViewportHandlers, document */
var Viewport = Class.create(UIElement, 
	...
	initialize: function (controller, options) {
		...
		this.headerAndFooterHeight = $(this.headerId).getDimensions().height + $(this.footerId).getDimensions().height + 9;
	...
	moveTo: function (x, y) {
        ...
        if (this.viewportHandlers.moveCounter === 0) {
            jQuery("#helioviewer-viewport").trigger('viewport-move');
		}      
	},
