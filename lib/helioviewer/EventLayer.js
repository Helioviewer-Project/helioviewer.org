...
var EventLayer = Class.create(Layer, {
    ...
    initialize: function (viewport, options) {
        ...
        this.lastZoomLevel = this.viewport.zoomLevel;
    ...
    displayEvents: function () {
        ...
        this.events.each(function (e) {
            ...
            var div = new Element('div', {className: 'event', style: 'position: absolute; left: ' + (pos.x - 2) + 'px; top: ' + (pos.y - 2) + 'px; width: 5px; height: 5px; background-color: #000; border: 1px solid #FFF; font-size: 3px; padding: 0;', title: e.detail });
            e.node = self.domNode.appendChild(div);
        });
        
        //Use custom tooltips (need to create large tooltip dialog)
        //this.viewport.controller.addToolTip(".event");        
    },
