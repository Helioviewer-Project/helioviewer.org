...
(function($)
{
	...
	$(function() {
		if($.browser.msie)
		{
			var ieCSS = document.styleSheets.qtip_vml;
	...
	function QTip(target, options, id)
	{
		...
		*/
		...
		function updateWidth(newWidth)
		{
			...
			var elems = self.elements, max, min;
		...
		$.extend(self, {
			...
			render: function(show)
			{
				...
				if(typeof options.style.border === 'object' && $.fn.qcorner)
				{
					...
					// Setup border width
					self.elements.wrapper.css({ borderWidth: options.style.border.border.width });

					// Apply the border
					self.elements.tooltip.qcorner(options.style.border);
