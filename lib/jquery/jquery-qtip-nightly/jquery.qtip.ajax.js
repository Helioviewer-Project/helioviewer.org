...
(function($)
{
	...
	$.fn.qtip.plugins.ajax = function(qTip)
	{
		...
		if(opts.ajax) {
			...
			if(typeof opts.ajax !== 'object'){ opts.ajax = { url: opts.ajax }; }
			if(opts.url){ opts.ajax.url = opts.url; delete opts.url; }
			if(opts.data){ opts.ajax.data = opts.data; delete opts.data; }
			if(opts.method){ opts.ajax.type = opts.method; delete opts.method; }
