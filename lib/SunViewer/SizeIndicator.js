...
SizeIndicator.prototype = Object.extend(new SunViewerWidget(), {
	...
	initialize: function(elementId, imageLayerProvider, options) {
		...
		//Re-position on viewport re-size
	...
	displaySize: function() {
		var widthKm = (this.width * SizeIndicator.sunRadiusKm) / (this.sunRadius * this.imageLayerProvider.tileContainer.tileSize * Math.pow(2, this.zoomLevel + this.zoomOffset - 12));
