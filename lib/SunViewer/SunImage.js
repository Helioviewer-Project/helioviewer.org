...
// Default options
	defaultOptions: $H({
		...
		wavelength:     null,
		resolution:      0,
		sunRadius:       959.705 / (2.63 * 1024), //The radius of the sun relative to the complete image (See wiki)
		zoomLevelOffset: 0
	}),
	
	/**
	 * @constructor
	 * @param {Hash} options	Available options: tileDir, tileSize, spacecraft, instrument, wavelength, resolution,  sunRadius, sunCenter, zoomLevelOffset, date
	 */
