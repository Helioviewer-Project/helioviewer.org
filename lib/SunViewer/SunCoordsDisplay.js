 ...
 */
 /*global Class, $, $H, Event, SunViewerWidget, Element */
...
SunCoordsDisplay.prototype = Object.extend({
	...
	createElements: function () {
		...
		this.latText = new Element('td', {width: '15'});
		this.latValue = new Element('td', {width: '25'});
		this.lonText = new Element('td', {width: '15'});
		this.lonValue = new Element('td', {width: '25'});
