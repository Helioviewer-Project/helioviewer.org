 ...
 */
 /*global document, Class, $, $A, $H, Element, Event, Effect, Debug, SunViewerWidget, TileLayerProvider, LayerConfigurator */
...
LayerManager.prototype = Object.extend(new SunViewerWidget(), {
	...
	createElements: function () {
		...
		//Menu header row
		var header = new Element('div', {width: '100%'});
		var headerL = new Element('span', {verticalAlign: 'middle', 'float': 'left', 'width': '240px'});
		var headerR = new Element('span', {textAlign: 'right'});
