 ...
 */
 /*global document, Class, $, $A, $H, Element, Event, Effect, Debug, TileLayerProvider, DomNodeCache, OverlayCollection, GLOBAL_zoomLevel, GLOBAL_zoomOffset */
...
OverlayLayerProvider.prototype = Object.extend(new TileLayerProvider(), {
	...
	onNewOverlay: function (overlay) {
	    //Debug.output("OverlayLayerProvider:onNewOverlay()");
