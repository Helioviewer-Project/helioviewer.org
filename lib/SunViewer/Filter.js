		...
		var sunImg = new SunImage(
			{
				...
				wavelength: "",
				resolution: "",
				tileDir: "/hvdb" + "/" + CurrentDate().getFullYear() + "/" + StringMonth + "/" + StringDay + "/" + StringHour  + "/" + Observatory + "/" + Instrument + "/" + Detector + "/" + Measurement + "/" + CurrentDate().getFullYear() + "_" + StringMonth + "_" + StringDay + "_" + StringHour + StringMinute + StringSecond + "_" + Observatory + "_" + Instrument + "_" + Detector + "_" + Measurement
			});
			return sunImg;
	}
	this.Next = function()
...
//var ExampleFilterCollection = new Filter();
//ExampleFilterCollection.Retreive("SOHO");
