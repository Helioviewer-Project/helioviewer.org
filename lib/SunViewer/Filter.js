...
function Filter(inst)
{
	...
	{
		return from.getFullYear().toString() + "-" + from.getMonth().toString() + "-" + (from.getDate()-3).toString();
	}
	function Criteria_ToDate(to)
	{
		return to.getFullYear().toString() + "-" + to.getMonth().toString() + "-" + (to.getDate()+3).toString();
	}
