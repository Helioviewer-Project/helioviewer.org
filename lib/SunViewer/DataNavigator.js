...
DataNavigator.prototype = {
    ...
    onObservationDateChange: function (type, args) {
        ...
        this.setTime(parseInt(date[0]), parseInt(date[1]), parseInt(date[2]));
    },
     ...
     */
     onTimeIncrementChange: function (type, args) {
        ...
        this.filters.each(function(filter) { 
            ...
            filter.value.Retreive(null, null, null, time);
	...
	makeNegative: function(obj) {
	    var newObj = [];
        $H(obj).each(function(h) {newObj[h.key.toString()] = -h.value;} );
        return newObj;    
	}
