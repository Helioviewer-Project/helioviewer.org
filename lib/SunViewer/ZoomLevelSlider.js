...
var ZoomLevelSlider = Class.create(UIElement, {
    /**
     * @constructor
     */
    initialize : function (controller, sliderHandleId, sliderTrackId, plusButtonId, minusButtonId, minValue, maxValue, initialValue) {
    ...
    */
    onChange : function (value) {
        ...
        //document.updateTiles.fire(); //depends on TLP and MLP both having correct zoomLevel value..
    },
