...
/**
 * @classDescription The Surface class enables the "panning/dragging"
...
Surface.prototype = Object.extend(new SunViewerWidget(), {
	...
	initialize: function(viewport, options) {
		...
		this.domNode = viewport.domNode.getElementsByClassName('surface')[0];
		...
		var pos = Position.cumulativeOffset(this.viewport.domNode);
