 ...
 */
 /*global Class, document, $H, Element, $, Event */
var Overlay = Class.create();

Overlay.prototype = Object.extend({
	defaultOptions: $H({
	...
	appendTo: function (layer, x, y) {
		...
		var bgElement = new Element('div', {'class': 'blackBg'});
	...
	showInfo: function (e, tileLayer) {
		...
		document.showOverlayInfo.fire({id: this.html, html: this.infoHtml, layer: this.domNode.parentNode, position: this.position});
	}
});
