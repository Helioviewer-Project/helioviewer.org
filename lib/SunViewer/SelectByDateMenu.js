...
SelectByDateMenu.prototype =  Object.extend(new SunViewerWidget(), {
	...
	populateDays: function(txt) {
        ...
        GLOBAL_TIME_YEAR  = this.date.year[0];
        GLOBAL_TIME_MONTH = this.date.month[0];
        GLOBAL_TIME_DAY   = this.date.day[0];
        
        //Configure initial value for the date input text field
        $('date').value = (GLOBAL_TIME_YEAR + " / " + GLOBAL_TIME_MONTH + " / " + GLOBAL_TIME_DAY);
