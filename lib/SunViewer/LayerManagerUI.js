    ...
    addMenuEntry: function (layerProvider) {
        ...
        switch (layerProvider.type) {
            case 'TileLayerProvider':
                ...
                this.accordionList.insert(li);
                
                // Event-handlers
                jQuery('#visibility-button-' + id).bind('click', {'id': id}, function(e) {
                	var visible = (e.target.value === "true") ? false : true;
                	...
                	e.target.setStyle({'background': 'url(images/blackGlass/' + icon + ')'});
            ...
            case 'MarkerLayerProvider': //Eventually events will be removed from the layer manager and treated separately...
                ...
                this.accordionList.insert({top:li});
                break;
            default:
    ...
    */
    createMenuRowHeader: function (layerProvider) {
        ...
        var visibilityBtn = Builder.node('button', {
        	...
        	value: true,
        	type: 'button',
        	style: 'background: url(images/blackGlass/LayerManagerButton_Visibility_Visible.png) transparent; margin-left: 10px; width:24px; height:14px;'
        });
        ...
        var removeBtn = Builder.node('button', {
        	...
        	value: true, 
        	type: 'button', 
        	style: 'background: url(images/blackGlass/LayerManagerButton_Remove_Shadow.png) transparent; margin-left: 10px; margin-right:8px;'
        });
