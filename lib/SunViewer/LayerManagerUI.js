...
LayerManagerUI.prototype = {
    ...
    render: function () {
    	...
    	this.accordion = jQuery('#' + this.innerContainer.identify()).accordion({
    		alwaysOpen: false,
    		active:     false,
    	...
    	// Icons
    	jQuery('#removeBtn').bind('click', function() { console.log ('layer remove button clicked!'); return false; });
    	jQuery('#visibilityBtn').bind('click', function(e) {
    		document.toggleLayerEnabled.fire(1, (e.target.value == "true" ? false : true));
        ...
        switch (layerProvider.type) {
            case 'TileLayerProvider':
                ...
                * */
                ...
                //li.appendChild (Builder.node('div', {className: 'layer-Head'}, layerProvider.sunImage.instrument));
                var header = Builder.node('div', {className: 'layer-Head'});
                header.insert(Builder.node ('span', {style: 'float: left;'}, layerProvider.sunImage.instrument));
                ...
                var visibilityBtn = Builder.node('button', {
                	...
                	value: true,
                	type: 'button',
                	style: 'background: url(images/blackGlass/LayerManagerButton_Visibility_Visible.png) transparent; margin-left: 230px;'
                	});
               	header.insert(visibilityBtn);
