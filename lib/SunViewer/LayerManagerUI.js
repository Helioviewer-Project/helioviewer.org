        ...
        switch (layerProvider.type) {
            case 'TileLayerProvider':
                ...
                * */
                ...
                header.insert(layerProvider.sunImage.instrument);
                
                var details = Builder.node('a', {href: '#', style: 'font-size:0.8em; color: gainsboro; text-decoration:none; margin-left: 10px;'}, '(details)')
                details.observe('click', function (e) { jQuery('#layerManager-Container').accordion("activate", 1); });
