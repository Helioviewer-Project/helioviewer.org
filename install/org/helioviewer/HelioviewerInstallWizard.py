...
class HelioviewerInstallWizard(QtGui.QWizard):
    ...
    def processImages(self):
        ...
        admin, adminpass, hvuser, hvpass, jp2dir = self.getFormFields()
        ...
        cursor = setupDatabaseSchema(admin, adminpass, hvuser, hvpass)
    ...
    def getFormFields(self):
        ...
        return admin, adminpass, hvuser, hvpass, jp2dir
