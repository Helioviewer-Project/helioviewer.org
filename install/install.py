...
def get_arguments():
    ...
    parser.add_option("-t", "--text-install",  dest="textinstall", help="Text-based installation", action="store_true")
    parser.add_option("-m", "--database-type", dest="dbtype",      help="Database [mysql|postgres]", default="mysql")
